...
public:
	...
	enum ChanErrorCodeBits {
      ...
      // PPM PHOS4 Scan
      Phos4ScanBadSignalBit=4,
      Phos4ScanBadWidthBit=5,
      Phos4ScanBadRiseTimeBit=6,
      Phos4ScanBadAdcDistribBit=7,
      Phos4ScanBadSignalShapeBit=8,
      Phos4ScanSaturatedSignalBit=9,
      
      // PPM SatBcid Analysis
      SatBcidTooFewSatPeaksBit=4,
      SatBcidNoSatPeaksBit=5,
      SatBcidTooFewSatSlices1Bit=6,
      SatBcidNoSatSlices1Bit=7,
      SatBcidTooFewSatSlices2Bit=8,
      SatBcidNoSatSlices2Bit=9,
   ...
   bool satBcidTooFewSatPeaks() const { return bitIsSet(SatBcidTooFewSatPeaksBit); }
   void satBcidTooFewSatPeaks(bool bad) { setBit(SatBcidTooFewSatPeaksBit,bad); }
   
   bool satBcidNoSatPeaks() const { return bitIsSet(SatBcidNoSatPeaksBit); }
   void satBcidNoSatPeaks(bool bad) { setBit(SatBcidNoSatPeaksBit,bad); }
   
   bool satBcidTooFewSatSlices1() const { return bitIsSet(SatBcidTooFewSatSlices1Bit); }
   void satBcidTooFewSatSlices1(bool bad) { setBit(SatBcidTooFewSatSlices1Bit,bad); }
   
   bool satBcidNoSatSlices1() const { return bitIsSet(SatBcidNoSatSlices1Bit); }
   void satBcidNoSatSlices1(bool bad) { setBit(SatBcidNoSatSlices1Bit,bad); }
   
   bool satBcidTooFewSatSlices2() const { return bitIsSet(SatBcidTooFewSatSlices2Bit); }
   void satBcidTooFewSatSlices2(bool bad) { setBit(SatBcidTooFewSatSlices2Bit,bad); }
   
   bool satBcidNoSatSlices2() const { return bitIsSet(SatBcidNoSatSlices2Bit); }
   void satBcidNoSatSlices2(bool bad) { setBit(SatBcidNoSatSlices2Bit,bad); }
